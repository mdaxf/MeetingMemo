...
*/
  ...
  //  this.createapicall('chat',model, body, successcallback, failcallback,completecallback);
    ...
    if(body){
      ...
      //  body.model = model;
        ...
        this.requestwithStream(`/engines/${model}/chats`, 'POST', body, successcallback,failcallback,completecallback);
    }
  ...
  creatimage(body, successcallback,failcallback,completecallback){      
    this.requestwithStream(`/images/generations`, 'POST', body, successcallback,failcallback,completecallback);
  }
